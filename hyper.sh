...
# Вивід привітального тексту
echo -e "${PINK}$(figlet -w 150 -f standard "Softs by Baryzhyk")${NC}"
echo "================================================================="
echo "Ласкаво просимо! Підпишись на мій Telegram-канал: https://t.me/sasha_postyt"
echo "================================================================="
echo ""
